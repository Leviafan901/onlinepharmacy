			    	...
			    	<li class="drugsForm__item">
			    		<div class="drugsForm__item-left">
			        		<div class="drugsForm__item-description">
			            	  <div><span>${author}: ${prescription.userName}&nbsp;${prescription.userLastname}</span></div>
			            	  <div><span>${medicine_name}: ${prescription.medicineName}</span></div>
			                ...
			                <form action="request-extention-prescription" method="POST" name="request-extend-prescription" style="float: right;">
		    ...
		    <div class="drugsForm__header" style="background-color: #92aeb7">
			    ...
			    <ul class="drugsForm__items">
			    	<li class="drugsForm__item">
			    		<div class="drugsForm__item-left">
			        		<div class="drugsForm__item-description">
			            	  <div><span>For whom: ${prescription.userName}&nbsp;${prescription.userLastname}</span></div>
			            	  <div><span>${medicine_name}: ${prescription.medicineName}</span></div>
			            	  <div><span>${creation_date}: ${prescription.creationDate}</span></div>
			            	  <div><span>${expiration_date}: ${prescription.expirationDate}</span></div>
			            	  <div>${text}: ${prescription.comment}</div>
