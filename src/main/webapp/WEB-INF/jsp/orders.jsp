			    	...
			    	<li class="drugsForm__item sku-holder" data-sku-id="60591" data-type="Dosage in mg" >
			        	...
			        	<div class="drugsForm__item-price">${order.status}</div>
			    		  ...
			    		  <div class="drugsForm__item-buttons">
			    		    <form action="get-prescription" method="GET" name="get-prescription">
			    		      <input name="order_id" type="text"  value="${order.orderId}" hidden="hidden" />
						      <input type="submit" value="GET PRESCRIPTION" class="drugsForm__button js-drugsForm__button" />
			                </form>
			              </div>
			            </c:if>
					</li>
